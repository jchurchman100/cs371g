...
//  assert(max<int>(2.3, 4)   == 4); // warning: implicit conversion from 'double' to 'int' changes value from 2.3 to 2 [-Wliteral-conversion]
    ...
    assert(strcmp(my_max             ("abc", "def"), "def") == 0); // char*, compare cstrings
//         strcmp(my_max<      char> ("abc", "def"), "def");       // T*,    compare chars
//         strcmp(my_max<const char*>("abc", "def"), "def");       // T,     compare addresses
